...
def main():
    ...
    if not os.path.exists(topics_path):
        # Fallback if topics.json missing
        topics = ["Logical Reasoning: Syllogisms", "Puzzles: Seating Arrangements (Linear)", 
                  "Puzzles: Seating Arrangements (Circular)", "Blood Relations and Family Tree", 
                  "Alphanumeric Series"]
    else:
